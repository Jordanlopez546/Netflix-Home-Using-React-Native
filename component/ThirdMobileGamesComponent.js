...
const ThirdMobileGamesComponent = ({name}) => {
    const data = [
        {
            id: '1',
    ...
    return (
        <View style={{flex:1, width: '100%'}}>
            ...
            <FlatList horizontal showsHorizontalScrollIndicator={false} data={data} keyExtractor={item => item.id} renderItem={({ item }) => <RenderItem item={item} />} />
        </View>
    )
}

export default ThirdMobileGamesComponent
